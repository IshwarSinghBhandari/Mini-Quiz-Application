...
public class Quiz extends JFrame implements ActionListener{
    ...
    Quiz(String username){
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("simple/minds/icons/loq.png"));
        JLabel l1 = new JLabel(i1);
        l1.setBounds(2, 0, 1340, 332);
        add(l1);
        
        qno = new JLabel("");
        qno.setFont(new Font("Tahoma", Font.PLAIN, 24));
        qno.setForeground(Color.green);
        qno.setBounds(50, 390, 50, 30);
        add(qno);
        
        question = new JLabel("");
        question.setFont(new Font("Tahoma", Font.PLAIN, 24));
        question.setForeground(Color.white);
        question.setBounds(100, 390, 900, 30);
        add(question);
        ...
        next.setBounds(975, 460, 200, 40);
        add(next);
        
        lifeline = new JButton("  50-50 Lifeline  ");
        lifeline.setFont(new Font("Tahoma", Font.PLAIN, 22));
        lifeline.setBackground(Color.BLACK);
        lifeline.setForeground(Color.CYAN);
        lifeline.setBounds(975, 520, 200, 40);
        ...
        submit.setBounds(975, 580, 200, 40);
        add(submit);
    ...
    public void paint(Graphics g){
        ...
        if(timer > 0) {
            g.drawString(time, 985, 400);
        }else {
            g.drawString("Times Up!!", 985, 400);
        }
